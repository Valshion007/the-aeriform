...
namespace SlugTemplate
{
    ...
    class Plugin : BaseUnityPlugin
    {
        ...
        public static readonly PlayerFeature<float> SuperJump = PlayerFloat("aeriform/super_jump");
        public static readonly PlayerFeature<bool> ExplodeOnDeath = PlayerBool("aeriform/explode_on_death");
        public static readonly GameFeature<float> MeanLizards = GameFloat("aeriform/mean_lizards");
